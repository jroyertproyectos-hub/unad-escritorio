        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              const Spacer(),
              _buildSidebarItem(Icons.settings, 'Configuracin', false, context),
              _buildSidebarItem(Icons.logout, 'Cerrar Sesin', false, context),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Aqu est el resumen de tus cursos y tareas.',
                    ...
                    ElevatedButton.icon(
                      onPressed: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Esto har el scraping directamente desde tu PC...'),
                          )
                        );
                      },
